...
# Quick lm-eval run for mamba-790m + motif2 rank1 PQ adapter.
...
ADAPTER=${ADAPTER:-/workspace/motif/logs/mamba790m_motif2_rank1_1M_notest_2gpu_ddp_kpq/pq_adapter_latest.pt}
BASE_MODEL=${BASE_MODEL:-${ROOT}/mamba-790m}
...
TAG=${TAG:-mamba790m_motif2_rank1_1M_quick}
