...
import sys
MAMBA_ROOT = os.environ.get("MAMBA_ROOT", "/XXX/mamba-main")
...
def parse_args():
    ...
    parser.add_argument("-data-dir", type=str, default="/workspace/datasets/SHD", help="root dir of SHD dataset")
    parser.add_argument("-out-dir", type=str, default="./motif/logs/shd", help="root dir for logs and checkpoints")
...
if __name__ == "__main__":
    ...
    # best_model_path = '/workspace/logs/shd/Trans_T200_b128_adam_lr0.001_t/checkpoint_max.pth'  
    # net = Trans()
    ...
    # parser.add_argument('-data-dir', default='/workspace/datasets/SHD', type=str)
