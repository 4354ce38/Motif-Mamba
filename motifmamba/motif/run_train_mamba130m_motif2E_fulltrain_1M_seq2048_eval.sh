...
# Mamba-130M + motif2E constraint + full-model training on Pile.
...
OUT_DIR=${OUT_DIR:-${ROOT}/motif/logs/pile_mamba130m_motif2E_rank2_fulltrain_1M_seq2048}
...
LM_TAG=${LM_TAG:-mamba130m_motif2E_rank2_fulltrain_1M_seq2048}
