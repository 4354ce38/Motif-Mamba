...
# Evaluate taskloss-only rank2 adapter with lm-eval cache reuse.

ROOT=${ROOT:-/workspace}
EVAL_SCRIPT=${EVAL_SCRIPT:-${ROOT}/mamba-main/motif/run_eval_kpq_full_suite.sh}

MODEL_DIR=${MODEL_DIR:-${ROOT}/motif/logs/pile_mamba130m_taskloss_only_pq_rank2_20260415_095148}
...
TAG=${TAG:-mamba130m_taskloss_only_pq_rank2_20260415_095148_cached}
