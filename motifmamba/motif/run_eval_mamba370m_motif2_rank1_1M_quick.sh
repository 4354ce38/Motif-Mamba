...
# Quick lm-eval run for mamba-370m + motif2 rank1 PQ adapter.
...
ADAPTER=${ADAPTER:-/workspace/motif/logs/mamba370m_motif2_rank1_1M_notest_1gpu/pq_adapter_latest.pt}
BASE_MODEL=${BASE_MODEL:-${ROOT}/mamba-370m}
...
TAG=${TAG:-mamba370m_motif2_rank1_1M_quick}
