...
# Evaluate motifFRPE rank2 1M checkpoint with lm-eval cache reuse.

ROOT=${ROOT:-/workspace}
EVAL_SCRIPT=${EVAL_SCRIPT:-${ROOT}/mamba-main/motif/run_eval_kpq_full_suite.sh}

MODEL_DIR=${MODEL_DIR:-${ROOT}/motif/logs/pile_mamba130m_motifFRPE_rank2_fulltrain_1M_seq2048_20260414_234504}
...
TAG=${TAG:-mamba130m_motifFRPE_rank2_fulltrain_1M_seq2048_cached}
